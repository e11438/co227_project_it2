...
compile_code('arm-linux-gnueabi-gcc -Wall -o test1'.$id.' test1'.$id.'.s', $stderr1, $stdout1);
...
run_code('qemu-arm -L /usr/arm-linux-gnueabi test1'.$id.'', $inputs, $stderr, $stdout);
